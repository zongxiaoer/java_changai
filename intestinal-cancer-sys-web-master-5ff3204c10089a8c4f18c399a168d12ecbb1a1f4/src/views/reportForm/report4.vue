    ...
    <div style="min-width: 941px;">
      <div class="btns">
        <!--<router-link to="/subjects/subjectsList">-->
          <el-button size="mini" class="return-home" @click="goBackD2()">返 回</el-button>
        <!--</router-link>-->
      ...
      <div class="formcon">
        ...
        <div class="tables">
          <el-form :inline="true" :model="formInline" class="demo-form-inline" label-width="120px" :rules="rules" ref="formInline1">
            ...
            <el-form-item label="填表人签名:" prop="tbrName" class="formhalfline">
              <el-input v-model="formInline.tbrName"  size="small" style="width: 220px;"></el-input>
            </el-form-item>
            ...
            <el-form-item label="质控者签名:" prop="zkzName" class="formhalfline">
              <el-input v-model="formInline.zkzName"  size="small" style="width: 220px;"></el-input>
            </el-form-item>
            <el-form-item label="工作人员编码:" class="formhalfline" prop="investigatorCode">
        ...
        <div class="tables">
          <el-form :model="formInline" class="demo-form-inline cmb cmba" :rules="rules" ref="formInline">
            ...
            <div v-if="formInline.item_1a_1" style="padding-left: 50px;">
              ...
              <el-form-item  prop="item_3a_1" >
                <el-checkbox-group v-model="formInline.item_3a_1" style="height: auto;">
                  <el-checkbox name="item_3a_1" label="1" class="db">01=年龄小于50或大于74岁；</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
              <el-form-item  prop="item_3a_2" >
                <el-checkbox-group v-model="formInline.item_3a_2" style="height: auto;margin-left: 30px;">
                  <el-checkbox label="1">02=曾有医生告诉过患有结直肠癌，若有，则结直肠癌确诊日期：
                    <el-date-picker
                  ...
                  <el-checkbox label="2" >为估计日期</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
              <el-form-item  prop="item_3a_3" >
                <el-checkbox-group v-model="formInline.item_3a_3" style="height: auto;">
                  <el-checkbox label="3" name="item_3a_3" class="db">03=进行过结直肠癌切除手术</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
              <el-form-item  prop="item_3a_4" >
                <el-checkbox-group v-model="formInline.item_3a_4" style="height: auto;">
                  <el-checkbox label="4" name="item_3a_4" class="db">04=正在接受任何癌症相关的治疗（非黑色素皮肤癌除外）</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
              <el-form-item  prop="item_3a_5" >
                <el-checkbox-group v-model="formInline.item_3a_5" style="height: auto;">
                  <el-checkbox label="5" name="item_3a_5"  class="db">05=在过去5年里，做过结肠镜、乙状结肠镜检查、气钡双重造影、CT仿真结肠镜等结直肠癌筛查；</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
              ...
              <el-form-item  prop="item_3a_6" >
                <el-checkbox-group v-model="formInline.item_3a_6" style="height: auto;">
                  <el-checkbox label="7" nam="item_3a_6" class="db">06=在过去1年里，接受过粪便潜血检测或者粪便DNA检测；</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
              <el-form-item  prop="item_3a_7" >
                <el-checkbox-group v-model="formInline.item_3a_7" style="height: auto;">
                  <el-checkbox label="8" name="item_3a_7" class="db">07=有下列下消化道疾病提示需要结肠镜进行确认？1）过去半年中长时间的直肠出血；2）明确诊断的缺铁性贫血；3）过去6个月中有记录的不明原因的体重下降（超过10%基础体重）</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
              <el-form-item  prop="item_3a_8" >
                <el-checkbox-group v-model="formInline.item_3a_8" style="height: auto;">
                  <el-checkbox label="9" name="item_3a_8" class="db">08=有其他严重疾病（包括严重的肺部疾病，晚期肾病，晚期肝病、严重的心衰、近期诊断为除黑色素皮肤癌外的其他癌症）；</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
              <el-form-item  prop="item_3a_9" >
                <el-checkbox-group v-model="formInline.item_3a_9" style="height: auto;">
                  <el-checkbox label="10" name="item_3a_9" class="db">09=未签署知情同意书；</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
              <el-form-item  prop="item_3a_10" >
                <el-checkbox-group v-model="formInline.item_3a_10" style="height: auto;">
                  <el-checkbox label="11" name="item_3a_10" class="db">10=随机分组后分配ID号后，因受试者主观原因（备注原因：
                    <el-input v-model="formInline.item_3a_10_cause"  size="small" style="width:220px;"></el-input>）在未接受任何筛查干预前决意退出试验。
                  </el-checkbox>
                </el-checkbox-group>
              </el-form-item>
            </div>
              <el-form-item  prop="item_1a_2" >
                <el-checkbox-group v-model="formInline.item_1a_2" style="height: auto;">
                  <el-checkbox name="item_1a_2" label="2"  class="db cmbi">02=对筛查对象进行了一次以上的随机分配（初始ID为：TC
                    <el-input v-model="formInline.item_1a_2_id"  size="small" :disabled="formInline.item_1a_2 == false" :maxlength='5' style="width:100px;height:34px;line-height: 34px;"></el-input>）
                  </el-checkbox>
                </el-checkbox-group>
              </el-form-item>
            ...
            <el-form-item  prop="item_1a_9" >
              <el-checkbox-group v-model="formInline.item_1a_9" style="height: auto;">
                <el-checkbox label="9" name="item_1a_9" class="db">09=随机分组分配ID号后，因受试者主观原因（备注原因：
                    <el-input v-model="formInline.item_1a_9_cause"  size="small" style="width:220px;"></el-input>），在进行到一定程度后决意退出试验（预约或完成了哪些检查，请说明：
            ...
            <el-form-item  prop="item_1a_10" >
              <el-checkbox-group v-model="formInline.item_1a_10" style="height: auto;">
                <el-checkbox label="10"  class="db">10=其它，请说明（请在下方详细说明任何上述未涉及的违规情况）：
                    ...
                    <el-input type="textarea" style="display:block; padding-right: 20px;" v-model="formInline.item_1a_10_other"></el-input>
            ...
            <el-form-item label="" prop="item_4a_1" style="padding:10px 0 0;margin-bottom:0;">
              <el-input type="textarea" prop="item_4a_1" style="display:block; padding-right: 20px;" v-model="formInline.item_4a_1"  placeholder="（非必填）"></el-input>
            </el-form-item>
          </el-form>
        </div>
      </div>
      <div class="text-center" style="margin-top: 40px;">
        <el-button type="primary" @click="submitForm()" ref="addBtn" id="buttonDtwoSave">提交</el-button>
...
//          document.getElementById('3a' ).scrollIntoView(true);
      ...
      return {
        ...
        rules:{
          ...
          investigatorCode:[{ required: true, message: '请输入', trigger: 'blur' }],
    ...
    methods:{
      ...
      getSiteId(){
        $axios_http({
          ...
          this.formInline.deptCode = res.data.data
      ...
      submitForm() {
        ...
        if (validd){
          ...
          console.log(dd)
          dd.item_1a_2_id = "TC"+ this.formInline.item_1a_2_id
          console.log(this.formInline.item_1a_2_id)
          var _url = '';
          if(this.$route.query.area && this.$route.query.area == 1){
            //地区用/base/update/violation/saveschemeInArea
             _url ='/base/update/violation/saveschemeInArea';
          }else{
             _url = '/base/update/violation/savescheme';
          }
          $axios_http({
