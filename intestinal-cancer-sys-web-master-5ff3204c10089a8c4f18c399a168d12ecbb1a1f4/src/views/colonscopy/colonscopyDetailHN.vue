    ...
    <div class="content">
      ...
      <div >
        ...
        <div class="booking-list">
            ...
            <div style="text-align:center;margin-top:10px;"><img src="../../assets/img/hnlc.jpg" alt=""></div>
            <p style="text-align:center;margin-top:10px;font-size:20px;"><u>病理诊断结果请一个月左右后于当地疾控中心或社区卫生服务中心领取!</u></p>
        </div>
      </div>
