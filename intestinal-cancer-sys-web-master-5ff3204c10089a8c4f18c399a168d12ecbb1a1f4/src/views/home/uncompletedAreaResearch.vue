<template>
  <div slot="right" class="content-page" v-if="uncompletedAreaResearch_page">
    <div class="content">
...
<script>
  export default {
    ...
    data () {
      return {
        uncompletedAreaResearch_page:false,
        btnAuth:{
    ...
    mounted(){
      let obj = this.checkPageAuth(this,"uncompletedAreaResearch_page",this.btnAuth)
    ...
    methods:{
      ...
      query(pageNo,pageSize){
        $axios_http({
          url:"/base/hospital/person/quitarealog/query",
          data:{
            name:this.qc.name,
            sid:this.qc.sid,
            phone:this.qc.phone,
