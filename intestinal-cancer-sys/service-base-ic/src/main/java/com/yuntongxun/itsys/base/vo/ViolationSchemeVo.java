 ...
 * @date 2018/4/19
 */
public class ViolationSchemeVo implements Serializable {
    private Integer id;
    ...
    private Integer item_1a_10;//其它，请说明（请在下方详细说明任何上述未涉及的违规情况）
    private String item_1a_10_other;//其他
    private String item_2a_1;// 方案违规事件发现日期
    private String item_2b_1;// 方案违规事件发生日期
    private Integer item_3a_1;// 年龄小于50或大于74岁 1：是，2：否
    private Integer item_3a_2;// 曾有医生告诉过患有结直肠癌   1：是，2：否
    private String item_3a_2_time;// 结直肠癌确诊日期
    ...
    public String getItem_2a_1() {
        return item_2a_1;
    }

    public void setItem_2a_1(String item_2a_1) {
        this.item_2a_1 = item_2a_1;
    }

    public String getItem_2b_1() {
        return item_2b_1;
    }

    public void setItem_2b_1(String item_2b_1) {
    ...
    public String getItem_3a_2_time() {
        return item_3a_2_time;
    }

    public void setItem_3a_2_time(String item_3a_2_time) {
