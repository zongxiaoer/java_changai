...
//	}
	...
	public static String changeSample(String sampletype){
		if(Constans.SAMPLE_TYPE1.equals(sampletype)){
			return Constans.SAMPLE_TYPE1_S;
		}else if(Constans.SAMPLE_TYPE2.equals(sampletype)){
			return Constans.SAMPLE_TYPE2_P;
		}else if(Constans.SAMPLE_TYPE3.equals(sampletype)){
			return Constans.SAMPLE_TYPE3_W;
		}
		return "";
	}
}
